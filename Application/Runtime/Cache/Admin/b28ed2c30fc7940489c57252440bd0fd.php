...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 病历维护 <span class="c-gray en">&gt;</span> 病例列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
			<a href="javascript:;" onclick="member_add('添加病历','<?php echo U('Admin/Record/record_add');?>','','310')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加病例信息</a>
		</span>
	 	<span class="r"></span> 
 	</div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="80">ID</th>
				<th width="100">病历名称</th>
				<th width="100">病历类别</th>
				<th width="90">添加人员</th>
				<th width="150">修改人员</th>
		...
		<tbody>
			<tr class="text-c">
				...
				<td class="td-status"><span class="label label-success radius">已启用</span></td>
					...
					<!-- <a title="编辑" href="javascript:;" onclick="member_edit('编辑','record-add.html','4','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>
					</a>  -->
