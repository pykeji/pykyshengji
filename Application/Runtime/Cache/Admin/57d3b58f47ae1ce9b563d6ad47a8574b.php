...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray">
		<span class="l">
			...
			<a class="btn btn-primary radius" href="javascript:;" onclick="admin_permission_add('添加权限','<?php echo U('Admin/Org/org_power_add');?>','800','300')">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c">
			...
			<td>使用者权限</td>
			<td>添加、修改、删除</td>
			<td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_permission_edit('权限编辑','<?php echo U('Admin/Org/org_power_editor');?>','800','300')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_permission_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
		</tr>
		</tbody>
	</table>
	</div>
