...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 医疗机构管理 <span class="c-gray en">&gt;</span> 医疗机构列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入机构编码、名称、等级" id="" name="">
		<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜医疗机构列表</button>
	</div>
...
<script type="text/javascript" src="/zysystem1/Public/admin/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
