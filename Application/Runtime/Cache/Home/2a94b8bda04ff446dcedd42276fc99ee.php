...
<head>
    ...
    <!-- Le styles -->
    <script type="text/javascript" src="/zysystem1/Public/muban/assets/js/jquery.min.js"></script>
    ...
    <link rel="stylesheet" href="/zysystem1/Public/muban/assets/css/signin.css">
...
<div id="test1" class="gmap3">
    <!-- <img src="/zysystem1/Public/" alt="background"> -->
</div>
<!--  END OF PAPER WRAP -->
<!-- MAIN EFFECT -->
<script type="text/javascript" src="/zysystem1/Public/muban/assets/js/preloader.js"></script>
...
<script type="text/javascript" src="/zysystem1/Public/muban/assets/js/map/gmap3.js"></script>
