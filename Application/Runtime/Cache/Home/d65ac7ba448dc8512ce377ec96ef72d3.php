...
<head>
	<title></title>
	<!-- 自己写的css -->
	<link rel="stylesheet" type="text/css" href="/zysystem1/Public/yeMiancss/binglicx.css">
	<!-- 日历的js -->
	<script type="text/javascript" src="/zysystem1/Public/rili/jeDate/jedate.js"></script>
	<!-- 健康档案 -->
	<link rel="stylesheet" href="/zysystem1/Public/mrjkda/jkda.css">
    <link rel="stylesheet" href="/zysystem1/Public/mrjkda/jiankang.css">
    <script src="/zysystem1/Public/mrjkda/Birthday-Calendar.js"></script>
    <!-- jQuery (Bootstrap 的 JavaScript 插件需要引入 jQuery) -->
    <script src="/zysystem1/Public/jq/jquery-3.1.1.min.js"></script>
    <!-- bootstrap的引用 -->
    <link href="/zysystem1/Public/bootstrap/css/bootstrap.css" rel="stylesheet">
...
<body>
	...
	<div class="zuokuaicxtj">
		<div class="chaxtjhanzi">
			<div  class="zuokuaicxtjtufd" >
				<img src="/zysystem1/Public/img/chaxun.png" style="width: 30px; margin-right: 10px;"  alt="图片加载中">
			</div>
	...
	<div class="youkuaixinx">
		...
		<div class="bingrxinxi">
			<div class="bingrxinxihz"><img src="/zysystem1/Public/img/014.png" style="width: 35px; margin-right: 10px;" alt="图片加载中。。。。"><b>病人信息</b></div>
			<!-- 表格 -->
		...
		<div class="jiuzhengjiru">
			<div class="jiuzhengjiruhz"> <img src="/zysystem1/Public/img/iconpng.png " style="width: 35px; margin-right: 10px;" alt="图片加载中。。。"><b>就诊记录</b></div>
    ...
    <script src="/zysystem1/Public/mrjkda/bingshi.js"></script>
