...
//    app.js更换背景颜色
    ...
    $(function() {
        $("#button-bg").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg5.jpg')no-repeat center center fixed"
            });
        });
        $("#button-bg2").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg2.jpg')no-repeat center center fixed"
            });
        });
        ...
        $("#button-bg3").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg.jpg')no-repeat center center fixed"
            });
        ...
        $("#button-bg5").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/giftly.png')repeat"
            });
        ...
        $("#button-bg7").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg3.png')repeat"
            });

        });
        $("#button-bg8").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg8.jpg')no-repeat center center fixed"
            });
        });
        $("#button-bg9").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg9.jpg')no-repeat center center fixed"
            });
        });

        $("#button-bg10").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg10.jpg')no-repeat center center fixed"
            });
        });
        $("#button-bg11").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg11.jpg')no-repeat center center fixed"
            });
        });
        $("#button-bg12").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg12.jpg')no-repeat center center fixed"
            });
        });

        $("#button-bg13").click(function() {
            $("body").css({
                "background": "url('/zysystem/Public/muban/assets/img/bg13.jpg')repeat"
            });
    ...
    head.js("/zysystem/Public/muban/assets/js/skin-select/jquery.cookie.js");
    head.js("/zysystem/Public/muban/assets/js/skin-select/skin-select.js");

    //Showing Date
    head.js("/zysystem/Public/muban/assets/js/clock/date.js");

    //Bootstrap
    //head.js("assets/js/bootstrap.js");

    //NEWS STICKER
    head.js("/zysystem/Public/muban/assets/js/newsticker/jquery.newsTicker.js", function() {
    ...
    head.js("/zysystem/Public/muban/assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {

        $(".topnav").accordionze({
            accordionze: true,
            speed: 500,
            closedSign: '<img src="/zysystem/Public/muban/assets/img/plus.png">',
            openedSign: '<img src="/zysystem/Public/muban/assets/img/minus.png">'
        });
    ...
    head.js("/zysystem/Public/muban/assets/js/slidebars/slidebars.min.js", "http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js", function() {
    ...
    //SEARCH MENU
    head.js("/zysystem/Public/muban/assets/js/search/jquery.quicksearch.js", function() {
    ...
    //EASY PIE CHART
    head.js("/zysystem/Public/muban/assets/js/gage/jquery.easypiechart.min.js", function() {
    ...
    head.js("/zysystem/Public/muban/assets/js/tip/jquery.tooltipster.js", function() {
    ...
    head.js("/zysystem/Public/muban/assets/js/nano/jquery.nanoscroller.js", function() {
    ...
    head.js("/zysystem/Public/muban/assets/js/pace/pace.js", function() {
    ...
    //SPARKLINE CHART
    head.js("/zysystem/Public/muban/assets/js/chart/jquery.sparkline.js", function() {
    ...
    //DIGITAL CLOCK
    head.js("/zysystem/Public/muban/assets/js/clock/jquery.clock.js", function() {
    ...
    head.js("/zysystem/Public/muban/assets/js/gage/raphael.2.1.0.min.js", "/zysystem/Public/muban/assets/js/gage/justgage.js", function() {
