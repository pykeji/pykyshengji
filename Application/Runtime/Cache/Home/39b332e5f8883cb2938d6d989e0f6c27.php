...
<head>
    ...
    <link rel="stylesheet" href="/44/zySystem/Public/muban/assets/css/style.css">
    <link rel="stylesheet" href="/44/zySystem/Public/muban/assets/css/loader-style.css">
    ...
    <![endif]-->
    <link rel="shortcut icon" href="/44/zySystem/Public/muban/assets/ico/minus.png">
</head>
            ...
            <div id="nt-title-container" class="navbar-left running-text visible-lg">
                ...
                <ul id="nt-title">
                    <div style="margin-top:-3px;margin-left:10%">
                        <iframe width="300" scrolling="no" height="25" frameborder="0" allowtransparency="true" src="/44/zySystem/Public/tqyxy.html">
                        </iframe>
                    </div>
                </ul>
            </div>
            <ul style="margin-right:0" class="nav navbar-nav navbar-right">
                <li><a data-toggle="dropdown" class="dropdown-toggle" href="#"><img alt="" class="admin-pic img-circle" src="/44/zySystem/Public/muban/assets/img/canga.jpg"> <?php echo $_SESSION['wh_userName']; ?> <b class="caret"></b></a>
...
<div id="skin-select">
    <div style="margin-top:-20px">
        <a href="http://www.pengyukeji.com"><img src="/44/zySystem/Public/muban/assets/img/pengyu1.png" alt="logo" style="width:150px;margin-left:30px"></a>
    </div>
...
<script type="text/javascript" src="/44/zySystem/Public/muban/assets/js/app.js"></script>
<script type="text/javascript" src="/44/zySystem/Public/muban/assets/js/load.js"></script>
<script type="text/javascript" src="/44/zySystem/Public/muban/assets/js/main.js"></script>
<script type="text/javascript" src="/44/zySystem/Public/muban/assets/js/jquery.easyui.min.js"></script>
<center>
    <p>
    </p>
    <p>
...
<!-- <script type="text/javascript" src="/44/zySystem/Public/js/jquery-3.1.1.min.js"></script> -->
