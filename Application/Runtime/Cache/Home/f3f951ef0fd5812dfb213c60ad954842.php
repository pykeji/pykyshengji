                        ...
                        <table border="1" cellspacing="1" class="jkda-table">
                            ...
                            <tr>
                                ...
                                <div class="xyzd1">
                                    ...
                                    <div class="div2">
                                        <?php if(is_array($xyName)): $i = 0; $__LIST__ = $xyName;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xy): $mod = ($i % 2 );++$i;?><label><input type="checkbox" name="xyzd1" class="xiyi1" onclick="checked2('xiyi1','xyzd1inp')" value="<?php echo ($xy["name"]); ?>"><span><?php echo ($xy["name"]); ?></span></label><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                            </tr>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <div class="xiyao">
                                        ...
                                        <table class="xyInf" width="100%">
                                            <?php if(is_array($xyCZ)): $i = 0; $__LIST__ = $xyCZ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xyInf): $mod = ($i % 2 );++$i;?><tr>
                                                    <td style="width:25%"><?php echo ($xyInf["yp_name"]); ?></td>
                                                    <td style="width:25%"><?php echo ($xyInf["yp_spec"]); ?></td>
                                                    <td style="width:10%"><?php echo ($xyInf["yp_total_amount"]); ?></td>
                                                    <td style="width:12.5%"><?php echo ($xyInf["yp_yc_amount"]); ?></td>
                                                    <td style="width:17.5%"><?php echo ($xyInf["yp_useage"]); ?></td>
                                                    <td style="width:10%"><?php echo ($xyInf["yp_pl_day"]); ?></td>
...
//    既往史AJAX
 $(document).on('input','#jws1inp',function(){
     ...
     var str="";
     $.ajax({
         url:"<?php echo U('JianKangAjax/jws');?>",
         type:'post',
         data:{'value':val},
         dataType:'json',
...
//传染病史AJAX
 $(document).on('input','#jws2inp',function(){
     ...
     var str="";
     $.ajax({
         url:"<?php echo U('JianKangAjax/crbs');?>",
         type:'post',
         data:{'value':val},
         dataType:'json',
         success:function(data){
...
$(document).on('input','#gmsinp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/gms');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#zt1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/wangshen');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#zt2inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/wangse');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#zt3inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/titai');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#zt4inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/tixing');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/shuimianzl');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz2inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/shuimiansj');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz3inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/shiyu');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz4inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/kouwei');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz5inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/dbbc');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz6inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/dbbz');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz7inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/xbbc');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xz8inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/xbbs');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#qz1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/xingqing');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#qz2inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/xingge');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#sz1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/shese');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#sz2inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/sheti');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#sz3inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/dongtai');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#sz4inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/taizhi');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#sz5inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/taise');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#mz1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/maizhen');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
...
$(document).on('input','#xyzd1inp',function(){
    ...
    var str="";
    $.ajax({
        url:"<?php echo U('JianKangAjax/xiyizd');?>",
        type:'post',
        data:{'value':val},
        dataType:'json',
        success:function(data){
